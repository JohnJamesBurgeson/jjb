...
$(document).ready(function () {
    ...
    $(document).scroll(function () {
        ...
        if (scroll_start > offset.top) {
            $('.nav-button').css('background-color', '#ebebe9');
        } else {
...
$(document).ready(function () {
    ...
    $(document).scroll(function () {
        scroll_start = $(this).scrollTop();
        if (scroll_start > offset.top) {
            $('.nav-about').css('color', '#b7bdc0');
        } else {
            $('.nav-about').css('color', '#ffffff');
        }
    });
});
...
$(document).ready(function () {
    ...
    $(document).scroll(function () {
        scroll_start = $(this).scrollTop();
        if (scroll_start > offset.top) {
            $('a.nav-email').css('color', '#b7bdc0');
        } else {
            $('a.nav-email').css('color', '#ffffff');
        }
    });
});
...
$(document).ready(function () {
    ...
    $(document).scroll(function () {
        scroll_start = $(this).scrollTop();
        if (scroll_start > offset.top) {
            $('a.nav-email:hover').css('border-bottom', '3px solid #9ba5a9');
        } else {
